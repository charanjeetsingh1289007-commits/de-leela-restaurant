      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16">
          <div>
            ...
            <p className="text-[#FAF9F6]/60 max-w-sm font-light leading-relaxed">
          ...
          <div>
            <h5 className="text-lg font-bold text-white mb-6 uppercase tracking-wider text-sm">Quick Links</h5>
          ...
          <div>
            <h5 className="text-lg font-bold text-white mb-6 uppercase tracking-wider text-sm">Follow Us</h5>
            <div className="flex space-x-4">
              <a href="#" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-[#D4AF37] hover:border-[#D4AF37] hover:text-[#1A1A1A] transition-all">
